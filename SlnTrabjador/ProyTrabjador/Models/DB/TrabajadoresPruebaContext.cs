...
public partial class TrabajadoresPruebaContext : DbContext
{
    ...
    // DbSet para mapear el resultado del procedimiento almacenado
    public DbSet<ProyTrabjador.Models.Listar_Trabajador> Listar_Trabajador { get; set; }

    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=DESKTOP-1QAON5U\\MSQLSERVER2022;Initial Catalog=TrabajadoresPrueba;Integrated Security=True;TrustServerCertificate=True;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Departamento>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Departam__3214EC07681E3924");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Distrito__3214EC07F9A3F146");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Provinci__3214EC07437EC35A");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Trabajad__3214EC07EC316CFE");
